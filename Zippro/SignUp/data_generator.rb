...
data[ 'phone' ]			= "559-354-9147"#business.local_phone
data[ 'areacode' ]		= "559"#business.local_phone.split("-")[0]
data[ 'exchange' ]		= "354"#business.local_phone.split("-")[1]
data[ 'last4' ]			= "9147"#business.local_phone.split("-")[2]
data[ 'fax' ]			= business.fax_number
data[ 'email' ]			= "unit61813@mypacks.net"#business.bings.first.email
