...
#adds the business, begins by clicking the "add this number" link
	...
	30.times { break if (begin @browser.text_field( :id, 'listingForm:newSic1').present? rescue Selenium::WebDriver::Error::NoSuchElementError end) == true; sleep 1 }
	...
	30.times { break if (begin @browser.table( :class, 'dr-sb-int-decor-table rich-sb-int-decor-table').present? rescue Selenium::WebDriver::Error::NoSuchElementError end) == true; sleep 1 }
...
#this method runs the show
	@browser.goto('http://thephonebook.consolidated.com/olc/lookup.faces')
